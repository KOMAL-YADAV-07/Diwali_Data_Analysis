...
Clean and preprocess the data (e.g., check for missing values, correct column names).

Explore the dataset using statistical summaries and visualizations.

Visualize key insights, such as:

Total sales by gender, age groups, and marital status

Top selling products

State‑wise sales performance

Differences in sales across occupations
...
Which gender or age group contributes most to sales.

Top‑selling states or regions.

Popular product categories during the Diwali period.
